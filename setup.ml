...
(* OASIS_START *)
(* DO NOT EDIT (digest: 378cbd283ea3d1ef4d0e545afb5c3da9) *)
(*
...
let setup_t =
  {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title =
                        "API reference for ocaml-redis (lwt backend)";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "W\144\020/9Y\255\180\000\228\161\215\198E\021k";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
